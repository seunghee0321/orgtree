...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		$("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"' style='border:0px'><img src='/AdminLTE2/etcplugins/jqgrid/img/loading.gif' border='0'><br/>"+(this.p.loadtext == null?"조회중":this.p.loadtext)+"</div>").insertBefore(gv);
		// $("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"' style='border:0px'><img src='/res/plugins/jqgrid/img/loading.gif' border='0'><br/>"+this.p.loadtext+"</div>").insertBefore(gv);

...
<a href="#" class="logo" style="cursor : default;">
  ...
  <span class="logo-lg" style="float:left;"><b>Organization Tree</b></span>
</a>
...
<nav class="navbar navbar-static-top" role="navigation">
  ...
  <div class="navbar-custom-menu">
    <ul class="nav navbar-nav">
	  ...
	  <!-- 매뉴얼 링크 -->
      <li>
        <a href="https://docs.google.com/document/d/e/2PACX-1vRUPXQ5phiPhr-K0QfaJTbcA8ucObxh2OC_nPM1UzOL9KXri3BOiHZ19WHryhK-Xx1i8BJvcCK3jrnm/pub" target="_blank"><i class="fa fa-question"></i></a>
      </li>

...
<head>
  ...
  <!-- JQueryUI -->
  <link rel="stylesheet" href="/AdminLTE2/etcplugins/jQueryUI/jquery-ui.css">
  
  <!-- JQGrid -->
  <link rel="stylesheet" href="/AdminLTE2/etcplugins/jqgrid/ui.jqgrid.css" />
  <link rel="stylesheet" href="/AdminLTE2/etcplugins/jqgrid/ui.jqgrid-bootstarp.css" />  
  
  <!-- Toastr -->
  <link rel="stylesheet" href="/AdminLTE2/etcplugins/toastr-master/build/toastr.min.css">  
  
  <!-- iCheck -->
  <link rel="stylesheet" href="/AdminLTE2/plugins/iCheck/square/blue.css">
    
  <!-- common css -->
  <link rel="stylesheet" href="/common/common/common.css">
